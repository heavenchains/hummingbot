...
global_config_map = {
    ...
    "paper_trade_enabled": ConfigVar(
        key="paper_trade_enabled",
    ...
    "bittrex_api_key": ConfigVar(
        key="bittrex_api_key",
        prompt="Enter your Bittrex API key >>> ",
        required_if=using_exchange("bittrex"),
        is_secure=True,
    ),
    "bittrex_secret_key": ConfigVar(
        key="bittrex_secret_key",
        prompt="Enter your Bittrex secret key >>> ",
        required_if=using_exchange("bittrex"),
        is_secure=True,
    ),
    "tex_chain_name": ConfigVar(
        key="ethereum_chain_name", prompt="What is your preferred ethereum chain name? >>> ", required_if=using_wallet
    ),
    "wallet": ConfigVar(
        key="wallet",
    ...
    "ethereum_token_overrides": ConfigVar(
        key="ethereum_token_overrides",
    ...
    "exchange_rate_default_data_feed": ConfigVar(
        key="exchange_rate_default_data_feed",
